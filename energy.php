        ...
        <div id="carouselExampleCaptions" class="carousel slide"data-bs-ride="carousel"  data-bs-interval="30000">
            ...
            <div class="carousel-inner" style="">
              ...
              <div class="carousel-item active" style="">
                    ...
                    <source src="images/ENERGYKAMVID.mp4" type="video/mp4">
                  </video>-->
              <div class="carousel-item active" style="background: linear-gradient(to bottom, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)),
              url(images/hydrogen-gas.jpg) no-repeat; background-size: cover; ">
                <div class="carousel-caption  d-md-block">
                    ...
                    <P>&nbsp;</p>
                    <span class="key-point">Electrical Energy Generation and Transmission</span>

                  <h1>ENERGY</h1>
                  <p>Our mission is to contribute with innovative generation of electrical power from renewable sources, transmission, control, storage and use of electrical energy at intelligent technical performance and reduced environment impact to ensure quality and sustainability.
                    </p>
                  <br>
              ...
              url(images/green-energy-kam.jpg) no-repeat; background-size: cover; ">
                <div class="carousel-caption  d-md-block">
                    ...
                    <span class="key-point">Green Energy and Smart Converter</span>
                  <h1>ENERGY</h1>
...
<!--<div style="" class="slide-show">
        <div id="carouselExampleCaptions" class="carousel slide"data-bs-ride="carousel">
            ...
            <div class="carousel-inner" style="">
              ...
              url(images/kam-energya.jpg) no-repeat; background-size: cover; ">
                <div class="carousel-caption  d-md-block">
                    <span class="key-point">Electrical Energy Generation and Transmission</span>
                  <h1>ENERGY</h1>
                  <p>Electricity is the ‘life blood’ of modern society and Kam Holding is involved in Powering homes and industries across Africa most populated country.</p>
                  <br>
                  <a href="about.php" class="readmore">Learn more <i class="fa fa-long-arrow-right"></i></a>
                </p>
                </div>
    ...
    <section class="brand-show p-default-2">
      <div class="container">
        <div class="brand-show-container">
          <div class="row">
            <h2 class="text-center mb-30">Brand Showcase</h2>
          </div>
          <div class="row">
            <div class="col-md-4">
             <div class="brand-img">
              <img src="images/hydrogen-gas.jpg" width="100%"alt="">
                <h5></h5>
             </div>
            </div>
            <div class="col-md-4">
              <div class="brand-img">
                <img src="images/gas-plant.png"width="100%" alt="">
                <h5></h5>
               </div>
            </div>
            <div class="col-md-4">
              <div class="brand-img">
                <img src="images/solar-power-plant1.jpg"width="100%" alt="">
                <h5></h5>
               </div>
            </div>
          </div>
