...
<div style="" class="slide-show">
        <div id="carouselExampleCaptions" class="carousel slide"data-bs-ride="carousel">
            ...
            <div class="carousel-inner" style="">
              ...
              url(images/roofing-sheet-banner.jpeg) no-repeat; background-size: cover; ">
...
<p>&nbsp;</p>
                  ...
                  <h1>Contact US</h1>
                  <p>Are you looking for quality rust free nails of all shapes and sizes?<br/>
Do you require TMT Rods that do not wear and corrode?<br/>
Is it scrap you need to sell off?<br/>
Or you are into construction and would want a variety of materials?<br/><br/>

Look no further than KAM Holding. <br/>
KAM Holding is your one stop shop for EVERYTHING CONSTRUCTION. <br/>
Contact Us today for all your materials requirements.</p>
                  <br>
                    ...
                    <div class="form-div b-shadow">
                        ...
                        <form action="contact.php" method="post">
                            ...
                            <select name="enquires">
                                ...
                                <option value="issues">Marketing/Sales</option>
                            </select>
                            <label for="">Business Unit</label>
                            <select name="business" id="">
                                <option value="Haulage Service">Steel Manufacturing</option>
                                <option value="packaging">Universal Roofing Sheets</option>
                                <option value="Steel Production">Packaging and Polythene</option>
                                <option value="Mining">Nails and Allied Products</option>
                                <option value="Binding Wire">Binding Wire</option>
                                <option value="Steel Production">Mining</option>
                                <option value="Roofing Sheets">Haulage Services</option>
                            </select>
                ...
                <div class="col-lg-4">
                    <div class="contact-info">
                        <div class="enquires b-shadow">
                            ...
                            <p>Email: frontdesk@kamholding.net</p>
                        </div>
...
<!--    <div class="row">
      ...
      <div class="col-md-3">
        <div class="contact-info">
          <div class="enquires b-shadow  h-100">
              <h6>DEPOT LAGOS</h6>
              <p>15/17, Banex House, Abimbola Street, Isolo Industrial Estate, Isolo, Lagos.</p>
      ...
      <div class="col-md-3">
        <div class="contact-info">
          <div class="enquires b-shadow  h-100">
              <h6>DEPOT IBADAN</h6>
              <p>No. 1, Ire Akari, Oluyole Extn. Junction, Beside NEPA office, Akala Express Road, Elebu, Ibadan, Oyo State.</p>
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        ...
        <iframe src="https://www.google.com/maps/d/embed?mid=1NI475pNTBGzH43pgrOYwIJ8oM5H6V2w&ehbc=2E312F" width="100%" height="900"></iframe>
    <script>
        function closeAlert(){
